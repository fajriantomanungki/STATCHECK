...
export default function BRSDataPage() {
  ...
  async function refresh() {
    ...
    try {
      ...
      setMessage("Data indikator berhasil diekstrak ulang dari Bahan Paparan aktif.");
